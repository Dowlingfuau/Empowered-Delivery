...
public static class PlayLibraryService
{
    public static List<Play> Plays = new()
    {
        ...
        new Play
        {
            ...
            Description = "Reflect on what the team loved, loathed, longed for, and learned, then turn that reflection into a small number of concrete actions.",
            Difficulty = "Easy",
            Duration = "60 minutes",
            Category = "Retrospective / Continuous Improvement",
            Route = "/plays/4ls-retrospective"
        }
    };
}
}
